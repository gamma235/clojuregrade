...
get the app created:
    ...
    $ heroku apps:create clojuregrade
    Creating clojuregrade... done, stack is cedar
    http://clojuregrade.herokuapp.com/ | git@heroku.com:clojuregrade.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://clojuregrade.herokuapp.com deployed to Heroku

    To git@heroku.com:clojuregrade.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://clojuregrade.herokuap.com
    ["Hello" :from Heroku]
